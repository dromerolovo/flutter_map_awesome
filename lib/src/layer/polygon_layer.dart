...
class PolygonPainter extends CustomPainter {
  ...
  void _paintPolygon(Canvas canvas, Rect rect) {
    ...
    if (null != polygonOpt.holeOffsetsList) {
      ...
      final pathHoles = Path();

      for (final offsets in polygonOpt.holeOffsetsList!) {
        
        pathHoles.addPolygon(offsets, true);
        canvas.drawPath(pathHoles, paint);
        
      }

      if (polygonOpt.gradient != null) {
        paint
          ..shader = polygonOpt.gradient!.createShader(pathHoles.getBounds())
      ...
      if (polygonOpt.gradient != null) {
        ...
        paint
          ...
          ..shader = polygonOpt.gradient!.createShader(path.getBounds());
